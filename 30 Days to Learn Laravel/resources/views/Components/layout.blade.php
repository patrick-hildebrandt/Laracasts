                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                {{-- leerer Slug ('/') wird als Sonderfall behandelt, sonst slug ohne '/' --}}
                                {{-- <a href="/"
                                ...
                                {{-- : behandelt value als expression, nicht als string --}}
                                {{-- leerer Slug ('/') wird als Sonderfall behandelt, sonst slug ohne '/' --}}
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm font-medium text-gray-400">patrick@koeper-it.de</div>
                        </div>
